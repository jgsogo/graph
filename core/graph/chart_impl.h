...
namespace core {
    namespace graph {
        ...
        namespace detail {
            ...
            */
            class chart_base { // Just for RTTI
                public:
                    virtual ~chart_base() {};
                };
            ...
            class chart_impl : public chart_base {
                ...
                public:
                    ...
                    int connected_components(_t_connected_components& vertex_at_cmp) const {
            ...
            ****************/
            ...
            class chart_behaviour<VertexType, EdgeType, BIDIRECTIONAL> 
                : public virtual chart_impl<VertexType, EdgeType, BIDIRECTIONAL> {
                public:
            ...
            template <class VertexType, class EdgeType>
            class chart_behaviour<VertexType, EdgeType, UNDIRECTED>
                : public virtual chart_impl<VertexType, EdgeType, UNDIRECTED> {
                public:
