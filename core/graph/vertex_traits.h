...
#include <memory>
#include <set>
#include "core/graph/graph_export.h"
    ...
    namespace graph {
        ...
        namespace detail {                                
            ...
            *************/
            ...
            //! \todo TODO: May merge this with qs_manager/has_member.cpp (consider implementing also for edge_connected)           
